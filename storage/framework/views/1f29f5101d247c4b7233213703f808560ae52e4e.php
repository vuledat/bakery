  ...
  <div class="container">
    <nav class="navbar navbar-default" role="navigation"> 
      ...
      <div class="navbar-header">
        <h1 class="navbar-brand"><a href="<?php echo e(route('index')); ?>">Backery<br />
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Danh mục</a>
              <ul class="dropdown-menu">
                <?php $__currentLoopData = getCategory(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<section class="slider"> <img src="images/icons/star.png" alt="star" class="absolute__img">
  <div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel">
    <div class="carousel-inner">
      <?php $__currentLoopData = getSlider(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="item <?php echo e($key == 0 ? 'active' : ''); ?>"> <img data-src="images/slider/image_1920x610.jpg" alt="First slide" src="<?php echo e(asset('images/'.$slider->img)); ?>">
        <div class="container">
          <div class="carousel-caption">
            <h1><?php echo e($slider->des_main); ?></h1>
            <h4 style="color:#fff;"><?php echo e($slider->des_extra); ?></h4>
...
<section class="main__middle__container">
  <div class="row text-center no-margin nothing">
    <div class="container headings">
      <h1 class="page_title"><?php echo e(getInfor()->name); ?></h1>
      <p class="small-paragraph">
        <?php echo e(getInfor()->content); ?>
  ...
  <div class="row  three__blocks text-center no_padding no-margin">
    <div class="container">
      ...
      <?php $__currentLoopData = getProduct(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-md-4">
          <h3><small><a href="#"><?php echo e($pro->name); ?> </a></small></h3>
          
          <img src="<?php echo e(asset('images/'.$pro->img)); ?>" width="250" height="250" alt="image" class="img-responsive img-rounded">
