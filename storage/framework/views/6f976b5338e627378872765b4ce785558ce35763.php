...
<head>
    ...
    <script src="<?php echo e(asset('js/bootstrap-flash-alert.js')); ?>"></script>
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo e(url('admin')); ?>">
            ...
            <div class="sidebar-brand-text mx-3"><?php echo e(trans('admin.logo')); ?><sup>dat</sup></div>
        </a>
        ...
        <li class="nav-item active">
            ...
            <div id="config-page" class="collapse hide" aria-labelledby="headingOne" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="<?php echo e(URL::route('infor.edit',1)); ?>">Infor</a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item <?php echo e(substr(Route::currentRouteName(), 0, strlen('product')) =='product' ? 'active-menu' : ''); ?>" href="<?php echo e(url('admin/product')); ?>">
                        Products Management
                    </a>
                    <a class="collapse-item <?php echo e(substr(Route::currentRouteName(), 0, strlen('category')) =='category' ? 'active-menu' : ''); ?>" href="<?php echo e(url('admin/category')); ?>">
                        Categories Management
                    </a>
                    <a class="collapse-item <?php echo e(substr(Route::currentRouteName(), 0, strlen('sliders')) =='sliders' ? 'active-menu' : ''); ?>" href="<?php echo e(url('admin/slider')); ?>">Member Management</a>
                    <a class="collapse-item" href="<?php echo e(url('admin/category')); ?>">User Management</a>
                    <a class="collapse-item <?php echo e(substr(Route::currentRouteName(), 0, strlen('slider')) =='slider' ? 'active-menu' : ''); ?>" href="<?php echo e(url('admin/slider')); ?>">Slider Management</a>
                    <a class="collapse-item" href="<?php echo e(url('category')); ?>">Slider Group Management</a>
                ...
                <ul class="navbar-nav mr-auto ml-md-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right border-0 shadow animated--grow-in" aria-labelledby="userDropdown">
                            <a class="dropdown-item" href="<?php echo e(url('admin/user/'.Auth::user()->id)); ?>">
