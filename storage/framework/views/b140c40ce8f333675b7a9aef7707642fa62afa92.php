        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="<?php echo e(url('admin/product')); ?>">Products Management</a>
                    <a class="collapse-item" href="<?php echo e(url('admin/category')); ?>">Categories Management</a>
                    <a class="collapse-item" href="<?php echo e(url('admin/category')); ?>">Member Management</a>
                    <a class="collapse-item" href="<?php echo e(url('admin/category')); ?>">User Management</a>
                    <a class="collapse-item" href="<?php echo e(url('category')); ?>">Slider Management</a>
